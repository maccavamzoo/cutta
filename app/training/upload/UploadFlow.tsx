...
export default function UploadFlow() {
  ...
  const [source, setSource] = useState<"strava" | "rouvy">("strava");
  ...
  const runExtraction = useCallback(async () => {
    ...
    try {
      const res = await fetch("/api/training-log/extract", {
        ...
        body: JSON.stringify({ imageBase64, mimeType: imageMimeType, source }),
      });
      ...
      setFields({
        durationMinutes: ext.fields.duration_minutes.value != null
          ? String(ext.fields.duration_minutes.value) : "",
        distanceKm: ext.fields.distance_km.value != null
          ? String(ext.fields.distance_km.value) : "",
        avgPowerWatts: ext.fields.avg_power_watts.value != null
          ? String(ext.fields.avg_power_watts.value) : "",
        avgHeartRate: ext.fields.avg_heart_rate.value != null
          ? String(ext.fields.avg_heart_rate.value) : "",
        elevationM: ext.fields.elevation_m.value != null
          ? String(ext.fields.elevation_m.value) : "",
        estimatedCalories: ext.fields.estimated_calories.value != null
          ? String(ext.fields.estimated_calories.value) : "",
      });
  ...
  }, [imageBase64, imageMimeType, source]);
      ...
      <div className="flex flex-col items-center justify-center py-20 text-center gap-4">
        ...
        <div>
          ...
          <p className="text-zinc-500 text-sm mt-1">
            Training data added to your log.
          </p>
        </div>
        <button
          onClick={reset}
          ...
          <div>
            ...
            <div className="bg-zinc-900 rounded-xl px-4">
              <FieldRow
                ...
                confidence={extraction.fields.duration_minutes.confidence}
              ...
              <FieldRow
                ...
                confidence={extraction.fields.distance_km.confidence}
                onChange={handleFieldChange}
              />
              <FieldRow
                label="Avg power"
                fieldKey="avgPowerWatts"
                unit="W"
                value={fields.avgPowerWatts}
                confidence={extraction.fields.avg_power_watts.confidence}
                onChange={handleFieldChange}
              />
              <FieldRow
                label="Avg heart rate"
                fieldKey="avgHeartRate"
                unit="bpm"
                value={fields.avgHeartRate}
                confidence={extraction.fields.avg_heart_rate.confidence}
                onChange={handleFieldChange}
              />
              <FieldRow
                label="Elevation"
                ...
                confidence={extraction.fields.elevation_m.confidence}
                onChange={handleFieldChange}
              />
              <FieldRow
                label="Calories"
                fieldKey="estimatedCalories"
                unit="kcal"
                value={fields.estimatedCalories}
                confidence={extraction.fields.estimated_calories.confidence}
                onChange={handleFieldChange}
              />
            </div>
          </div>
